...
const Header = () => {
  ...
  return (
    <header className="bg-white dark:bg-gray-900 border-b border-picton-blue-100 dark:border-gray-800 shadow-sm sticky top-0 z-30 transition-colors duration-300">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => handleNav("accueil", "/")}>
          ...
          <span className="text-picton-blue-800 dark:text-slate-100 font-black text-base sm:text-lg tracking-tight">
          ...
          {navSection.map(({ key, label, path }) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 cursor-pointer
                ${navActive === key
                  ? "bg-picton-blue-500 text-white shadow-md shadow-picton-blue-200 dark:shadow-gray-800"
                  : "text-picton-blue-600 dark:text-slate-300 hover:bg-picton-blue-50 dark:hover:bg-gray-800"}`}
            >
              {label}
            </button>
          ))}
        ...
        <div className="flex items-center gap-1 sm:hidden">
          <button
            className="p-2 rounded-lg text-picton-blue-600 dark:text-slate-300 hover:bg-picton-blue-50 dark:hover:bg-gray-800 transition-colors"
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="overflow-hidden sm:hidden border-t border-picton-blue-100 dark:border-gray-800"
          >
